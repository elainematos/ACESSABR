...
function Footer(){
    return(
        <footer className="footer">
            <div className="footer__section footer__section__first">
            ...
            <div className="footer__section footer__section__second">
                <div className="footer__container">
                    <p>
                        <strong>Projeto Elaborado durante a RDW <a href="https://ebaconline.com" target="_blank">E.B.A.C</a> 2021</strong>
                        <small>
                        Projetado por <a href="https://github.com/cavalcantemmarcelo" target="_blank">Marcelo Cavalcante</a> e <a href="https://github.com/mja-maia/" target="_blank">Miguel Maia</a>, desenvolvido por Elaine Matos Aluno EBAC. 
                        </small>
                    </p> 
